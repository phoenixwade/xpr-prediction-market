    ...
    <div className="market-stats">
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-value">{(stats.totalVolume / 1000000).toFixed(2)} XUSDC</div>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{(stats.avgTradeSize / 1000000).toFixed(2)} XUSDC</div>
        </div>
        <div className="stat-card">
          <div className="stat-label">24h Volume</div>
          <div className="stat-value">{(stats.last24hVolume / 1000000).toFixed(2)} XUSDC</div>
        </div>
        <div className="stat-card">
