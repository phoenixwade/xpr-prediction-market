    ...
    <div className="market-stats">
      ...
      <div className="stats-grid">
        <div className="stat-card">
          ...
          <div className="stat-value">{stats.totalVolume} USDTEST</div>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          ...
          <div className="stat-value">{stats.avgTradeSize} USDTEST</div>
        </div>
        <div className="stat-card">
          <div className="stat-label">24h Volume</div>
          <div className="stat-value">{stats.last24hVolume} USDTEST</div>
        </div>
        <div className="stat-card">
