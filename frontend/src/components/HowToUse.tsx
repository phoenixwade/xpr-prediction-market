      ...
      <div className="how-to-use-content">
        ...
        <div className="how-to-use-intro">
          <p>
            ...
            You can buy "Yes" or "No" shares for any market, and if your prediction is correct, each share pays out 1 XUSDC.
          </p>
        </div>
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-step">
            ...
            <p>
              ...
              you'll receive 1 XUSDC, making a profit of 0.35 XUSDC per share.
            </p>
          </div>
        </div>
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-step">
            ...
            <p>
              <strong>Important:</strong> When you place an order, the required XUSDC is automatically transferred from your wallet.
              You don't need to deposit funds separately!
            </p>
            <ul>
              <li><strong>Buy Orders:</strong> You'll transfer (price × quantity) XUSDC</li>
              <li><strong>Sell Orders:</strong> If you don't own shares, you'll transfer 1 XUSDC per share as collateral</li>
            </ul>
          </div>
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-step">
            ...
            <ul>
              <li><strong>Available Balance:</strong> XUSDC available for trading (from deposits, cancelled orders, and trade profits)</li>
          ...
          <div className="how-to-use-step">
            ...
            <p>
              To withdraw XUSDC back to your wallet:
            </p>
            <ol>
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-step">
            ...
            <ul>
              ...
              <li>Winning shares can be claimed for 1 XUSDC each</li>
          ...
          <div className="how-to-use-step">
            ...
            <p>
              Your winnings (1 XUSDC per winning share) will be added to your internal balance.
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-step">
            ...
            <ul>
              <li>Buyer pays 0.6500 XUSDC for 1 share</li>
              <li>Seller receives 0.6499 XUSDC (0.6500 - 0.01% fee)</li>
              <li>Platform collects 0.0001 XUSDC as fee</li>
            </ul>
          </div>
        </div>
        ...
        <div className="how-to-use-section">
          ...
          <div className="how-to-use-help">
            ...
            <ul>
              ...
              <li>Make sure you have enough XUSDC in your wallet for trading</li>
